...
if (isset($_SERVER['HTTP_X_REQUESTED_WITH']) && ($_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest')) {
  ...
  // sql statement untuk menampilkan data dari tabel "tbl_antrian_loket" berdasarkan "tanggal"
  $query = mysqli_query($mysqli, "SELECT id, no_antrian, status, jenis FROM tbl_antrian_loket 
